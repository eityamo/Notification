module NotificationPdf
  class PostPdf < Prawn::Document
    ...
    def create_form(record)
      text_box "#{record.myname}""    ""(#{record.old}歳)", at: [150, 550], size: 12
      text_box "#{record.fromdate}から", at: [150, 490], size: 12
      text_box "#{record.todate}まで", at: [150, 460], size: 12
      text_box "#{record.yourname}", at: [150, 400], size: 12
      text_box "#{record.getup}", at: [200, 320], size: 12
      text_box "#{record.cleanup}", at: [200, 270], size: 12
      text_box "#{record.note}", at: [200, 220], size: 12
    end
